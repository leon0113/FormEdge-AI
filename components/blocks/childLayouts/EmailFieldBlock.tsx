...
const blockType: FormBlockType = "EmailField";
...
const propertiesValidateSchema = z.object({
    ...
    label: z.string().trim().min(2).max(50).email(),
    required: z.boolean().default(false),
    helperText: z.string().trim().max(255).optional(),
});

export const EmailFieldBlock: ObjectBlockType = {
    blockType,
    blockCategory,
    ...
    canvasComponent: EmailFieldCanvasComponent,
    formComponent: EmailFieldFormComponent,
    propertiesComponent: EmailFieldPropertiesComponent,
};
...
function EmailFieldCanvasComponent({
    blockInstance,
}: {
...
function EmailFieldPropertiesComponent({
    positionIndex,
    parentId,
    blockInstance,
}: {
...
function EmailFieldFormComponent({
    ...
    const validateField = (val: string) => {
        const result = propertiesValidateSchema.safeParse({
            placeHolder,
            label: val,
            required,
            helperText,
