...
import { generateFormQuestionPrompt } from "@/lib/ai/prompts";
import { AIChatSession } from "@/lib/ai/gemini-ai";
    ...
    return (
        <>
            <Popover open={isOpen} onOpenChange={setIsOpen}>
                ...
                >
                    <div
                        className="flex flex-col  w-[390px] bg-white border-2 border-green-200 rounded-lg px-5  pb-[14px] pt-[18px] shadow-xl">
                        ...
                        <div className="flex justify-between items-center mt-4">
                            <div
                                role="button"
                                className=" text-green-500 font-medium underline text-sm ml-1"
                        ...
                        {show && (
                            <div
                                className="flex flex-col rounded border border-green-300 bg-green-100 text-green-500 px-3 pt-3 mt-2 mb-1">
